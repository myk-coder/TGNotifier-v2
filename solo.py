...
start_char = ["/", "_", "🚀", "✴️", "🚨", "📣", "💫", "✅", "🐱", "✈️", "⏰", "💊", "🎁", "🦊", "🔥", "✨", "🟢", "💥", "😏", "➡️", "💲", "Next", "Sex"]
word_list = ["sex", "nude"]  # Add more words as needed
keywords = [
    "phrase", "stak", "wallet", "cant", "can't", "eth", "unstake", "delegat", "undelegate", "error", "revert", "fail", "claim", "meta", "help", "where", "0x", "execution", "fix", "bug", "issue", "status", "load", "not", "kyc", "register", "days", "hours", "when", "why", "what", "who", "stop", "work", "broken", "lp", "reward", "pool", "liquid", "add", "valid", "node", "support", "withdraw", "token", "ledger", "keplr", "sale", "yield", "swap", "validat", "?"
